...
- Keep responses short and conversational.`,
    },
    {
        ...
        shortDescription: "A student is still confused about APA citations, so you must reformulate with a genuinely different explanation.",
        fullDescription: "You are leading a freshman writing workshop. A student is still confused about APA in-text citations and says your first explanation did not click. Your goal is to reformulate using a different structure, wording, or example instead of repeating yourself.",
        level: "intermediate",
        estimatedMinutes: 4,
        maxTurns: 8,
        studentProfile: {
            name: "Priya",
            personality: "Willing to learn, informal speaker, and quick to notice when the TA repeats the same explanation.",
            openingLine: "Sorry, I'm still kind of lost on the citation thing. Like, what actually goes in the parentheses and what goes in the sentence?",
        },
        objective: {
            title: "Reformulating After Non-Understanding",
            description: "Give a substantively different second explanation with a concrete example, not a repeated version of the first explanation.",
            successCriteria: "The ITA provides a genuinely different second explanation with a new structure or example and helps the student track the APA pattern.",
            examplePhrases: [
...
- Keep replies short, informal, and student-like.`,
    },
    {
        ...
        shortDescription: "A student asks a policy question outside your certainty, so you must be honest and still helpful.",
        fullDescription: "You are a TA in Intro to Economics. A student asks whether the US Federal Reserve has ever used negative interest rates. You are not fully sure of the exact answer. Your goal is to acknowledge uncertainty, connect to what you do know, and offer a concrete path to verify.",
        level: "intermediate",
        estimatedMinutes: 4,
        maxTurns: 8,
        studentProfile: {
            name: "Marcus",
            personality: "Curious and direct. Appreciates honesty, but pushes back on answers that sound made up.",
            openingLine: "Has the Fed ever actually done negative interest rates? Like, has that happened here in the US?",
        },
        objective: {
            title: "Handling Questions Beyond Your Knowledge",
            description: "Be transparent about uncertainty, connect to relevant knowledge, and provide a concrete way to find the answer.",
            successCriteria: "The ITA avoids making up facts, clearly states uncertainty, adds relevant context they do know, and gives a practical next step for verification.",
            examplePhrases: [
...
- Keep responses concise and natural.`,
    },
    {
        ...
        shortDescription: "A first-time lab student needs titration steps one at a time with check-ins.",
        fullDescription: "You are a TA in an intro chemistry lab. A student is doing titration for the first time and needs four steps in sequence: fill burette, measure analyte, add indicator, and titrate slowly to endpoint. Your goal is to give instructions step by step and check in before moving on.",
        level: "beginner",
        estimatedMinutes: 5,
        maxTurns: 10,
        studentProfile: {
            name: "Taylor",
            personality: "Attentive and cooperative, but gets overwhelmed when too many steps are delivered at once.",
        ...
        objective: {
            ...
            description: "Deliver instructions in clear order, pause between steps, and confirm readiness before continuing. \nSteps: fill burette, measure analyte, add indicator, and titrate slowly to endpoint.",
            successCriteria: "The ITA guides the student through the process in a clear sequence with check-ins, instead of listing the whole procedure in one dump.",
            examplePhrases: [
